...
public record ExtractedItem(
    ...
    @JsonPropertyDescription("Title of the book, CD or DVD") String title,
    @JsonPropertyDescription("Author, composer or performer. Null when not visible.") String author,
    @JsonPropertyDescription("BOOK for printed media, CD for audio media, DVD for video media") String mediaType) {
}
